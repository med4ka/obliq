...
class StockObservationItem(BaseModel):
    """One daily stock price observation (SCHEMA.md stock_observations)."""
    ...
    def _ser_price(self, value, _info):
        return _ser_decimal(value)
...
class StockHistoryResponse(BaseModel):
    ...
    count: int = 0
    items: list[StockObservationItem] = []
...
class StockListItem(BaseModel):
    ...
    @field_serializer("latest_close", "change", "change_pct")
    def _ser_stock_val(self, value, _info):
        return _ser_decimal(value)
